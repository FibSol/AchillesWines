...
"""
WDC.be scraper — retail price ingestion via HTML catalog.

WDC is a Belgian wine retailer (French-language). Product listings are
served as paginated HTML cards at /fr/vins?page=N.
"""
import hashlib
import json
import logging
        ...
        with httpx.Client(headers=headers, timeout=30, follow_redirects=True) as client:
            ...
            while True:
                ...
                if resp.status_code in (403, 429):
                    msg = f"Blocked by wdc.be: HTTP {resp.status_code} on {url}"
                ...
                for card in product_cards:
                    ...
                    try:
                        inserted = insert_staging_candidate(
                            self.conn,
                            wine_key=wine_key, source_key=SOURCE_KEY, retailer="wdc_be",
